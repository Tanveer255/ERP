...
public class ProductionController : ControllerBase
{
    ...
    /// <summary>
    /// Advance production order: complete current operation, start next operation, return current and next operation names
    /// </summary>
    /// <param name="orderId"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Complete production added logic: consume reserved stock, produce finished goods, update order status to Completed, handle concurrency with transaction
    /// </summary>
    /// <param name="orderId"></param>
    /// <returns></returns>
